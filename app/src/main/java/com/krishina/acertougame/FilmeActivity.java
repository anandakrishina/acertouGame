...
public class FilmeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        perguntas = getResources().getStringArray(R.array.perguntasFilme);
        respostaCorreta = getResources().getIntArray(R.array.respostasCorretasFilme);
        alternativas = new String[][]{
                getResources().getStringArray(R.array.opcao0Filme),
                getResources().getStringArray(R.array.opcao1Filme),
                getResources().getStringArray(R.array.opcao2Filme),
        };
            ...
            public void onClick(View view) {
                ...
                if (idBotaoSelecionado != -1) {
                    ...
                    if(verificaAcerto.verificarAcerto(indexRespostaSelecionada,respostaCorreta[index]) ==1){
                        Toast.makeText(FilmeActivity.this, "ACERTOOOU", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(FilmeActivity.this, "ERROOOUUU", Toast.LENGTH_SHORT).show();
                    }
